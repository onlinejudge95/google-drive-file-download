...
def get_credentials():
    ...
    credential_path = os.path.join(
        credential_dir, "drive-copy-google-folders.json"
    )
...
def main():
    ...
    log_filename = os.path.join(
        args.log_dir,
        "copy-google-drive-folder-{}.log".format(
                ...
                if page_counter >= args.start_page:
                    ...
                    for this_file in file_page["files"]:
                        ...
                        if (
                            ...
                            copied_file = (
                                drive_service.files()
                                .copy(fileId=this_file["id"], body=new_file)
                                .execute()
                            )
                    ...
                    log.info("Skipping Page {}".format(page_counter))
